  ...
  topFeatures: [
    {
      title: "Strikes",
      description:
        "Our striking system allows you to strike your staff members, remove the strike and list strikes!",
      icon: <Magic fill="#FF4ECD" />,
    },
    {
      title: "Breaks",
      description:
        "Our break system allows staff to request and take a break with use of a single command.",
      icon: <Flash fill="#FF4ECD" />,
    },
    {
      title: "Disciplinaries & Chats",
      description:
        "We make it easy to get in contact with your staff members when they make a mistake and give them a helping hand.",
      icon: <Moon fill="#FF4ECD" />,
    },
    {
      title: "Clocking",
      description:
        "Our innovative clocking systems allows staff to clock in and out to log how long they have worked for.",
  ...
  fullFeatures: [
    {
      title: "Strike System",
      description:
        "The ability to strike team members at your fingertips. Users are alerted when a strike is made against their profile..",
      icon: <Magic fill="#FF4ECD" />,
    },
    {
      title: "Break System",
      description:
        "The ability to allow your staff to have restful breaks. Enable the optional feature to remove staff roles while a user is on break to remove the urge to work.",
      icon: <Flash fill="#FF4ECD" />,
    },
    {
      title: "Contact System",
      description:
        "We all make mistakes. Management should be there to support us. Our contact system allows you to get in contact with staff.",
      icon: <Moon fill="#FF4ECD" />,
    },
    {
      title: "Multi Guild Linking",
      description:
        "Add Resolv to your main serer and staff server. Link the two servers together and enable extra features!.",
